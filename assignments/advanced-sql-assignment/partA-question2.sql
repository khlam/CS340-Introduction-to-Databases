...
((SELECT id FROM employee WHERE first_name = "Ananya" AND last_name = "Jaiswal"), (SELECT id FROM project WHERE name = "Chan'g"), "2012-01-01"),
((SELECT id FROM employee WHERE first_name = "Michael" AND last_name = "Fern"), (SELECT id FROM project WHERE name = "The Robinson Project"), "2013-08-08"),
((SELECT id FROM employee WHERE first_name = "Abdul" AND last_name = "Rehman"), (SELECT id FROM project WHERE name = "Diamond"), "2014-09-11");
